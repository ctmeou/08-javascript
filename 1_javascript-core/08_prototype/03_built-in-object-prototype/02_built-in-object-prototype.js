// Function, String, Number를 비롯한 내장 객체들 역시 프로토타입에 메소드를 저장한다.
...
// Object.prototype에도 toString이 있지만 중복 메소드가 있는 경우 체인에서 가까운 메소드가 사용되어 Number.prototype의 toString이 사용된다.
console.log(num);
console.log(num.toString());

// 내장 프로토타입을 수정할 수 있지만 되도록 변경하지 않는다.
// 명세서에 새로 등록된 기능을 쓰고 싶지만 자바스크립트 엔진에 구현되어 있지 않은 경우 정도에만 변형한다.
