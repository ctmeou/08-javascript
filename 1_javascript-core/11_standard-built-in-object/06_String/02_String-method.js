...
console.log(str.indexOf('a'));                              // 문자열에서 a 검색하여 첫 번째 인덱스 반환
...
// 첫 번째 인수로 전달 받은 문자열 또는 정규표현식을 검색하여 두 번째 인수로 전달한 문자열로 치환한 문자열 반환
console.log(str.replace('Java', 'Type'));
console.log(str.replace('a', 'b'));                         // 검색 된 문자열이 여럿 존재할 경우 첫 번째로 검색된 문자열만 치환
console.log(str.replace(/j/i,'Z'));                         // 첫 번째 인수로 정규표현식 전달
console.log('--------------------------------');

// String.prototype.split 
// 첫 번째 인수로 전달한 문자열 또는 정규식을 검색하여 문자열을 구분한 후 분리 된 각 문자열로 이루어진 배열 반환
