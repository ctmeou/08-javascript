...
// Number.POSITIVE_INFINITY : 양의 무한대를 나타내는 숫자 값 Infinity와 같다
console.log(Number.POSITIVE_INFINITY);

// Number.NEGATIVE_INFINITY : 음의 무한대를 나타내는 숫자 값 -Infinity와 같다
...
function isEqual (a, b) {
    // a - b의 절댓값이 Number.EPSILON보다 작으면 같은 수로 인정한다
